...
class TestOSXOS(unittest.TestCase):
    ...
    def test_normalize_path_linux(self):
        self._test_normaliz_path (test_data.DIR_LINUX_1, test_data.DIR_OSX_1)
    
    def test_normalize_path_osx(self):
        self._test_normaliz_path (test_data.DIR_OSX_1, test_data.DIR_OSX_1)
    
    def test_normalize_path_windows(self):
        self._test_normaliz_path (test_data.DIR_WINDOWS_1, test_data.DIR_OSX_1)
